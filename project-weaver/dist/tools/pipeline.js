...
import { PIPELINE_STAGES, STAGE_AGENT_MAP, STAGE_DESCRIPTIONS, AGENT_DISPLAY_NAMES, } from '../types.js';
...
export function registerPipeline(server) {
    server.tool('run_pipeline', 'Run the full AI Software Agency pipeline: spec -> stories -> architecture -> implementation -> testing -> review -> ship. Returns a structured execution plan for Gemini to follow step by step.', {
