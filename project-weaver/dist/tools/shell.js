...
export function registerShell(server) {
    // --- run_command ---
    server.tool('run_command', 'Run a shell command in the workspace directory and capture its output. Use this for running tests, builds, linters, or any CLI tool. Has a timeout to prevent hanging.', {
